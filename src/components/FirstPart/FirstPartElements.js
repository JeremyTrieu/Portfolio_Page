...
export const FirstPartBackground = styled.div`
    position: absolute;
    top: 0;
    right: 0;
    bottom: 0;
...
export const FirstPartContent = styled.div`
    z-index: 3;
    max-width: 1200px;
    position: absolute;
    padding: 8px 24px;
...
export const FirstPartH1 = styled.h1`
    color: #fff;
    font-size: 48px;
    text-align: center;
...
export const FirstPartBtwnWrapper = styled.div`
    margin-top: 32px;
    display: flex;
    flex-direction: column;
    align-items: center;
